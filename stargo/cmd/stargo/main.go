...
Example:
    ...
    >>> if err: ...
    >>> ''.join([chr(x) for x in data])[:50]  # TODO: better way to convert []byte to string
    "<!DOCTYPE html>\n<html>\n<head>\n<meta http-equiv=\"Co"
...
func main() {
	...
	resolve.AllowAddressable = true // TODO: crucial! set within stargo?
